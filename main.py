...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post,form=comment_form,data_comment=text_comment, Logged_in=current_user.is_authenticated, logged_name=current_user.name)
